...
wallPortal.add_membrane_q6i(1, 1, 2, 4, 3, "muro")
wallPortal.add_membrane_q6i(2, 3, 4, 6, 5, "muro")
wallPortal.add_membrane_q6i(3, 5, 6, 8, 7, "muro")
wallPortal.add_membrane_q6i(4, 9, 10, 12, 11, "muro")
wallPortal.add_membrane_q6i(5, 11, 12, 14, 13, "muro")
wallPortal.add_membrane_q6i(6, 13, 14, 16, 15, "muro")
# wallPortal.add_elastic_euler_bernoulli_beam(7, 4, 11, "vig40x40")
# wallPortal.add_elastic_euler_bernoulli_beam(8, 6, 13, "vig40x40")
# wallPortal.add_elastic_euler_bernoulli_beam(9, 8, 15, "vig40x40")
...
wallPortal.add_restraint(1, *(True, True, False))
wallPortal.add_restraint(2, *(True, True, False))
wallPortal.add_restraint(9, *(True, True, False))
wallPortal.add_restraint(10, *(True, True, False))
